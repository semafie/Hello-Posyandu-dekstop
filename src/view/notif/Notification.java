...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/notif/sucess.png")));
            lbMessage.setText("Berhasil");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/notif/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/notif/fail.png")));
            lbMessage.setText("Perhatian");
        }
    ...
    public void paint(Graphics grphcs) {
        ...
        if (type == Type.SUCCESS) {
            ...
            g2.setColor(new Color(255, 196, 117));
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/notif/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/notif/close.png"))); // NOI18N
