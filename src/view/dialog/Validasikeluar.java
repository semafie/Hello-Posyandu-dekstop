 ...
 * @author RESCOM-1
 */
public class Validasikeluar extends Dialog {

    /**
     * Creates new form Validasikeluar
     */
    public Validasikeluar(JFrame fram) {
        super(fram);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/image/Validasilogout.png"))); // NOI18N
