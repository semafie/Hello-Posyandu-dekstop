...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new view.customdate.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new view.customdate.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new view.customdate.Button();
        cmdPrevious = new view.customdate.Button();
        slide = new view.customdate.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/customdate/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/customdate/previous.png"))); // NOI18N
    ...
    private view.customdate.Button cmdForward;
    private view.customdate.Button cmdMonth;
    private view.customdate.Button cmdPrevious;
    private view.customdate.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private view.customdate.Slider slide;
